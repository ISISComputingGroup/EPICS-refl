...
class TestComponent(unittest.TestCase):
    ...
    def test_GIVEN_component_has_offset_WHEN_requesting_intercept_in_mantid_coordinates_THEN_offset_is_ignored_in_result(
        self,
    ):
        beam_angle = 45.0
        comp_z = 10.0
...
class TestTiltingJaws(unittest.TestCase):
    def test_GIVEN_tilting_jaw_input_beam_is_at_60_deg_WHEN_set_angular_displacement_THEN_beam_no_altered(
        ...
        jaws.beam_path_set_point.set_incoming_beam(beam_start)
        jaws.beam_path_set_point.axis[ChangeAxis.ANGLE].set_displacement(
            CorrectedReadbackUpdate(123, None, None)
        )
    ...
    def test_GIVEN_component_WHEN_set_relative_position_of_position_THEN_position_axis_has_changed_set_but_angle_does_not(
        self,
    ):
    ...
    def test_GIVEN_component_WHEN_set_relative_position_of_angle_THEN_angle_axis_has_changed_set_but_position_does_not(
        self,
    ):
        comp = TiltingComponent("component", setup=PositionAndAngle(0, 0, 90))
        comp.beam_path_set_point.set_incoming_beam(PositionAndAngle(0, 0, 0))
...
class TestActiveComponents(unittest.TestCase):
    def test_GIVEN_angled_mirror_is_not_in_beam_WHEN_get_beam_out_THEN_outgoing_beam_is_incoming_beam(
        self,
    ):
        ...
        mirror.beam_path_set_point.axis[ChangeAxis.ANGLE].set_displacement(
            CorrectedReadbackUpdate(mirror_angle, None, None)
        )
...
class TestObservationOfComponentReadback(unittest.TestCase):
    ...
    def test_GIVEN_listener_WHEN_readback_changes_THEN_listener_is_informed(self):
        ...
        self.component.beam_path_rbv.axis[ChangeAxis.POSITION].set_displacement(
            CorrectedReadbackUpdate(1, None, None)
        )
    ...
    def test_GIVEN_listener_WHEN_beam_changes_THEN_listener_is_informed(self):
        ...
        beam_y = 1
        self.component.beam_path_rbv.axis[ChangeAxis.POSITION].set_displacement(
            CorrectedReadbackUpdate(expected_value + beam_y, None, None)
        )
...
class TestThetaComponent(unittest.TestCase):
    ...
    def test_GIVEN_next_component_is_in_beam_WHEN_get_read_back_THEN_half_angle_to_component_is_readback(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
        ...
        result = theta.beam_path_rbv.axis[ChangeAxis.ANGLE].get_relative_to_beam()
        theta_calc_set_of_incoming_beam_next_comp = (
        ...
        assert_that(
            theta_calc_set_of_incoming_beam_next_comp,
            is_(position_and_angle(theta.beam_path_set_point.get_outgoing_beam())),
            "This component has defined theta rbv",
        )

    def test_GIVEN_next_component_is_in_beam_and_at_45_degrees_WHEN_get_read_back_THEN_half_angle_to_component_is_readback(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
    ...
    def test_GIVEN_next_component_is_in_beam_and_at_90_degrees_WHEN_get_read_back_THEN_half_angle_to_component_is_readback(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
    ...
    def test_GIVEN_next_component_is_not_in_beam_and_next_component_but_one_is_in_beam_WHEN_get_read_back_THEN_half_angle_to_component_is_readback_and_theta_calc_set_of_incoming_beam_is_set(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
        ...
        theta_calc_set_of_incoming_beam_next_comp_but_one = (
            next_but_one_component.beam_path_rbv.substitute_incoming_beam_for_displacement
        )
        ...
        assert_that(
            theta_calc_set_of_incoming_beam_next_comp,
            is_(None),
            "This component does not define theta rbv",
        )
        assert_that(
            theta_calc_set_of_incoming_beam_next_comp_but_one,
            is_(position_and_angle(theta.beam_path_set_point.get_outgoing_beam())),
    ...
    def test_GIVEN_next_component_is_in_beam_and_next_component_but_one_is_also_in_beam_WHEN_get_read_back_THEN_half_angle_to_first_component_is_readback_and_theta_cal_set_only_on_first_component(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
    ...
    def test_GIVEN_next_component_is_in_beam_WHEN_set_next_component_displacement_THEN_change_in_beam_path_triggered_at_least_once(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
    ...
    def test_GIVEN_next_component_is_in_beam_WHEN_set_next_component_incoming_beam_THEN_change_in_beam_path_is_not_triggered(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
    ...
    def test_GIVEN_next_component_is_in_beam_and_at_45_degrees_and_not_on_axis_WHEN_get_read_back_THEN_half_angle_to_component_is_readback(
        self,
    ):
    ...
    def test_GIVEN_next_component_is_in_beam_and_at_45_degrees_and_incoming_angle_is_45_WHEN_get_read_back_THEN_half_angle_to_component_is_readback(
        self,
    ):
        beam_start = PositionAndAngle(y=10, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
    ...
    def test_GIVEN_next_component_is_in_beam_theta_is_set_to_0_and_component_is_at_45_degrees_WHEN_get_read_back_from_component_THEN_component_readback_is_relative_to_setpoint_beam_not_readback_beam_and_is_not_0_and_outgoing_beam_is_readback_outgoing_beam(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
        ...
        result_position = next_component.beam_path_rbv.axis[
            ChangeAxis.POSITION
        ...
        assert_that(
            result_outgoing_beam, is_(position_and_angle(theta.beam_path_rbv.get_outgoing_beam()))
        )

    def test_GIVEN_next_component_is_in_beam_and_disabled_WHEN_theta_rbv_changed_THEN_beampath_on_rbv_is_updated(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
    ...
    def test_GIVEN_next_component_is_in_beam_and_at_45_degrees_and_incoming_angle_is_45_WHEN_get_init_sp_THEN_half_angle_to_component_is_readback(
        self,
    ):
        beam_start = PositionAndAngle(y=10, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
    ...
    def test_GIVEN_next_component_is_in_beam_and_at_47_degrees_with_an_autosaved_offset_of_2_and_incoming_angle_is_45_WHEN_get_init_sp_THEN_half_angle_to_component_minus_offset_is_readback(
        self,
    ):
        offset = 2
        beam_start = PositionAndAngle(y=10, z=0, angle=0)
        ...
        theta.add_angle_of(next_component)
        theta.beam_path_rbv.set_incoming_beam(beam_start)
        next_component.beam_path_set_point.axis[ChangeAxis.ANGLE].init_displacement_from_motor(
            45 + offset
        )
    ...
    def test_GIVEN_theta_dependent_on_multiple_axis_WHEN_one_axis_major_and_other_axis_no_THEN_theta_is_major(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
        ...
        theta.add_angle_to(next_component)
        next_component.beam_path_rbv.axis[ChangeAxis.POSITION].set_displacement(
            CorrectedReadbackUpdate(0, AlarmSeverity.Major, AlarmStatus.HiHi)
        )
        next_component.beam_path_rbv.axis[ChangeAxis.LONG_AXIS].set_displacement(
            CorrectedReadbackUpdate(0, AlarmSeverity.No, AlarmStatus.Low)
        )
        theta.beam_path_rbv.set_incoming_beam(beam_start)

        theta_alarm = theta.beam_path_rbv.axis[ChangeAxis.ANGLE].alarm

        assert_that(theta_alarm, is_((AlarmSeverity.Major, AlarmStatus.HiHi)))

    def test_GIVEN_theta_dependent_on_multiple_axis_WHEN_one_axis_major_and_other_axis_minor_THEN_theta_is_major(
        self,
    ):
        beam_start = PositionAndAngle(y=0, z=0, angle=0)
        theta = ThetaComponent("theta", setup=PositionAndAngle(0, 5, 90))
        ...
        theta.add_angle_to(next_component)
        next_component.beam_path_rbv.axis[ChangeAxis.POSITION].set_displacement(
            CorrectedReadbackUpdate(0, AlarmSeverity.Minor, AlarmStatus.HiHi)
        )
        next_component.beam_path_rbv.axis[ChangeAxis.LONG_AXIS].set_displacement(
            CorrectedReadbackUpdate(0, AlarmSeverity.Major, AlarmStatus.Low)
        )
        theta.beam_path_rbv.set_incoming_beam(beam_start)

        theta_alarm = theta.beam_path_rbv.axis[ChangeAxis.ANGLE].alarm

        assert_that(theta_alarm, is_((AlarmSeverity.Major, AlarmStatus.Low)))
...
class TestComponentInitialisation(unittest.TestCase):
    def setUp(self):
        ...
        self.component = TiltingComponent(
            "component", setup=PositionAndAngle(0, self.Z_COMPONENT, 90)
        )
    ...
    def test_GIVEN_component_has_autosaved_offset_WHEN_incoming_beam_changes_on_init_THEN_displacement_is_beam_intercept_plus_offset(
        self,
    ):
        autosaved_offset = 1
        self.component.beam_path_set_point.axis[
            ChangeAxis.POSITION
        ].autosaved_value = autosaved_offset
    ...
    def test_GIVEN_component_has_autosaved_angle_WHEN_incoming_beam_changes_on_init_THEN_angle_is_beam_angle_plus_offset(
        self,
    ):
        autosaved_offset = 1
    ...
    def test_GIVEN_component_has_autosave_position_WHEN_incoming_beam_changes_on_init_THEN_pos_relative_to_beam_is_autosaved_offset(
        self,
    ):
        autosaved_offset = 1
        self.component.beam_path_set_point.axis[
    ...
    def test_GIVEN_component_has_autosave_angle_WHEN_incoming_beam_changes_on_init_THEN_angle_relative_to_beam_is_autosaved_offset(
        self,
    ):
        autosaved_offset = 1
        self.component.beam_path_set_point.axis[ChangeAxis.ANGLE].autosaved_value = autosaved_offset
    ...
    def test_GIVEN_component_has_no_autosaved_offset_WHEN_incoming_beam_changes_on_init_THEN_displacement_is_unchanged(
        self,
    ):
    ...
    def test_GIVEN_component_has_no_autosave_position_WHEN_incoming_beam_changes_on_init_THEN_pos_relative_to_beam_is_displacement_minus_beam_intercept(
        ...
        displacement = 5
        self.component.beam_path_set_point.axis[ChangeAxis.POSITION].set_displacement(
    ...
    def test_GIVEN_theta_angled_to_autosaved_comp_WHEN_initialising_comp_THEN_theta_is_init_with_regards_to_beam_intercept(
        self,
    ):
        ...
        self.component.beam_path_set_point.axis[ChangeAxis.POSITION].init_displacement_from_motor(
            z_theta + offset_comp
        )
...
class TestComponentAlarms(unittest.TestCase):
    ...
    def test_WHEN_init_THEN_component_alarms_are_undefined(self):
        self.assertEqual(
            self.component.beam_path_rbv.axis[ChangeAxis.POSITION].alarm, self.UNDEFINED
        )
        self.assertEqual(self.component.beam_path_rbv.axis[ChangeAxis.ANGLE].alarm, self.UNDEFINED)
        self.assertEqual(
            self.component.beam_path_set_point.axis[ChangeAxis.POSITION].alarm, self.UNDEFINED
        )
        self.assertEqual(
            self.component.beam_path_set_point.axis[ChangeAxis.ANGLE].alarm, self.UNDEFINED
        )
    ...
    def test_GIVEN_theta_angled_to_component_WHEN_updating_displacement_with_alarms_on_component_THEN_theta_angle_alarm_set(
        self,
    ):
        ...
        self.component.beam_path_rbv.axis[ChangeAxis.LONG_AXIS].set_alarm(
            AlarmSeverity.No, AlarmStatus.No
        )
        self.component.beam_path_rbv.axis[ChangeAxis.POSITION].set_displacement(update)
    ...
    def test_GIVEN_theta_angled_of_component_WHEN_updating_displacement_with_alarms_on_component_THEN_theta_angle_alarm_set(
        self,
    ):
        self.theta = ThetaComponent("theta", setup=PositionAndAngle(0, 1, 90))
    ...
    def test_GIVEN_theta_angled_to_component_WHEN_updating_angle_with_alarms_on_component_THEN_theta_angle_is_unchanged(
        self,
    ):
        self.theta = ThetaComponent("theta", setup=PositionAndAngle(0, 1, 90))
        self.theta.add_angle_to(self.component)
    ...
    def test_GIVEN_theta_angled_to_two_components_one_not_in_beam_WHEN_updating_displacement_of_out_of_beam_coomponent_with_alarms_on_component_THEN_theta_angle_alarm_not_set(
        self,
    ):
        self.theta = ThetaComponent("theta", setup=PositionAndAngle(0, 1, 90))
    ...
    def test_GIVEN_theta_angled_of_two_components_one_not_in_beam_WHEN_updating_displacement_of_out_of_beam_component_with_alarms_on_component_THEN_theta_angle_alarm_not_set(
        self,
    ):
        self.theta = ThetaComponent("theta", setup=PositionAndAngle(0, 1, 90))
        component2 = ReflectingComponent("component2", setup=PositionAndAngle(0, 2, 90))
...
class TestThetaChange(unittest.TestCase):
    ...
    def test_GIVEN_component_pointed_at_by_theta_changes_WHEN_get_theta_change_THEN_theta_is_changing(
        self, is_changing
    ):
        self.theta.add_angle_to(self.component)
    ...
    @parameterized.expand([(True,), (False,)])
    def test_GIVEN_2_components_pointed_at_by_theta_changes_when_first_out_of_beam_WHEN_get_theta_change_THEN_theta_is_changing_as_second_component(
        self, is_changing
    ):
        self.theta.add_angle_to(self.component)
    ...
    @parameterized.expand([(True,), (False,)])
    def test_GIVEN_component_pointed_at_by_theta_changes_angle_of_WHEN_get_theta_change_THEN_theta_is_changing(
        self, is_changing
    ):
        self.theta.add_angle_of(self.component)
    ...
    def test_GIVEN_2_components_pointed_at_by_theta_changes_when_neither_in_WHEN_get_theta_change_THEN_theta_is_changing_as_first_or_second_component(
        self, is_changing_1, is_changing_2
    ):
    ...
    @parameterized.expand([(True,), (False,)])
    def test_GIVEN_long_axis_of_component_pointed_at_by_theta_changes_WHEN_get_theta_change_THEN_theta_is_changing(
        self, is_changing
    ):
        self.theta.add_angle_to(self.component)
        self.component.beam_path_rbv.axis[ChangeAxis.LONG_AXIS].is_changing = is_changing
...
class TestComponentDisablingAndAutosaveInit(unittest.TestCase):
    ...
    def test_GIVEN_component_WHEN_disabled_THEN_incoming_beam_for_rbv_and_sp_are_saved(
        self, mock_auto_save
    ):
        ...
        mock_auto_save.write_parameter.assert_has_calls(
            [
                call(expected_name + "_rbv", expected_incoming_beam_rbv),
                call(expected_name + "_sp", expected_incoming_beam_sp),
            ],
            any_order=True,
        )
    ...
    def test_GIVEN_position_and_angle_WHEN_convert_from_none_THEN_value_error(self):
        assert_that(
            calling(PositionAndAngle.autosave_convert_for_read).with_args(None), raises(ValueError)
        )

    def test_GIVEN_position_and_angle_WHEN_convert_from_nonsense_THEN_raises_value_error(self):
        assert_that(
            calling(PositionAndAngle.autosave_convert_for_read).with_args("blah"),
            raises(ValueError),
        )

    @patch("ReflectometryServer.beam_path_calc.disable_mode_autosave")
    def test_GIVEN_component_WHEN_init_disabled_with_valid_beam_THEN_incoming_beam_is_restored(
        self, mock_auto_save
    ):
        ...
        assert_that(
            component.beam_path_set_point.get_outgoing_beam(),
            position_and_angle(expected_incoming_beam),
        )

    @patch("ReflectometryServer.beam_path_calc.disable_mode_autosave")
    def test_GIVEN_component_WHEN_init_disabled_with_invalid_beam_THEN_incoming_beam_is_0_0_0(
        self, mock_auto_save
    ):
    ...
    @patch("ReflectometryServer.beam_path_calc.disable_mode_autosave")
    def test_GIVEN_component_WHEN_init_enabled_with_valid_beam_THEN_incoming_beam_is_not_restored(
        self, mock_auto_save
    ):
        expected_incoming_beam = PositionAndAngle(0, 0, 0)
    ...
    @patch("ReflectometryServer.beam_path_calc.disable_mode_autosave")
    def test_GIVEN_component_WHEN_disabled_and_incoming_beam_change_forced_THEN_incoming_beam_for_rbv_and_sp_are_saved(
        self, mock_auto_save
    ):
        expected_incoming_beam_sp = PositionAndAngle(1, 2, 3)
        expected_incoming_beam_rbv = PositionAndAngle(1, 2, 3)
...
class TestBenchComponent(unittest.TestCase):
    ...
    def test_GIVEN_set_height_axis_with_0_angle_WHEN_get_axis_value_THEN_j1_value_returned_and_axis_changed(
        self, axis, position, expected_result
    ):
    ...
    @parameterized.expand(
        [
            ...
            (
                ChangeAxis.JACK_FRONT,
                -0.1,
                -50.88767676,
            ),  # expected values from spreadsheet + height
            ...
            (
                ...
                BENCH_MIN_ANGLE,
                -27.44574943,
            ),  # expected values from spreadsheet + height at min angle
            (
                ChangeAxis.SLIDE,
                BENCH_MIN_ANGLE - 0.1,
                -27.44574943,
            ),  # expected values from spreadsheet + height at 0 deg because of cut off
            (
                ChangeAxis.SLIDE,
                BENCH_MAX_ANGLE,
                24.79311549,
            ),  # expected values from spreadsheet + height at max angle
            (
                ChangeAxis.SLIDE,
                BENCH_MAX_ANGLE + 1.0,
                24.79311549,
            ),  # expected values from spreadsheet + height at 4.8 deg because of cut off
        ]
    )
    def test_GIVEN_set_height_axis_WHEN_get_axis_value_THEN_j1_value_returned_and_axis_changed(
        self, axis, angle, expected_result
    ):
        bench = get_standard_bench()
        bench.beam_path_set_point.set_incoming_beam(PositionAndAngle(0, 0, 0))
    ...
    def test_GIVEN_set_seesaw_axis_with_0_angle_and_height_WHEN_get_axis_value_THEN_j1_value_returned_and_axis_changed(
    ...
    @parameterized.expand(
        [
            (
                (ChangeAxis.POSITION, ChangeAxis.ANGLE, ChangeAxis.SEESAW),
                (),
                (),
                (ChangeAxis.JACK_FRONT,),
                True,
    ...
    def test_GIVEN_changing_true_on_some_axis_WHEN_changing_set_on_an_axis_THEN_bench_angle_seesaw_and_height_on_changing_to_expected_answer(
        self,
        inital_setup_false,
        inital_setup_true,
        axes_to_set_false,
    ...
    @parameterized.expand([(1, 1, 1), (-4, -4, -4), (2, 2, 2)])
    def test_GIVEN_set_jacks_with_height_with_0_angle_at_seesaw_setpoint_0_WHEN_get_control_axis_value_THEN_values_correct(
        self, jack_front_position, jack_rear_position, expected_position
    ):
        bench = get_standard_bench(with_angle=0)
        bench.beam_path_set_point.set_incoming_beam(PositionAndAngle(0, 0, 0))
        position = AxisParameter("PARAM", bench, ChangeAxis.POSITION)
        ...
        bench.beam_path_rbv.axis[ChangeAxis.JACK_FRONT].set_displacement(
            CorrectedReadbackUpdate(jack_front_position, AlarmSeverity.No, AlarmStatus.No)
        )
        bench.beam_path_rbv.axis[ChangeAxis.JACK_REAR].set_displacement(
            CorrectedReadbackUpdate(jack_rear_position, AlarmSeverity.No, AlarmStatus.No)
        )
    ...
    def test_GIVEN_set_jacks_with_height_seesaw_setpoint_0_WHEN_get_control_axis_value_THEN_values_correct(
        self, jack_front_position, jack_rear_position, expected_position, expected_angle
    ):
        bench = get_standard_bench()
        bench.beam_path_set_point.set_incoming_beam(PositionAndAngle(0, 0, 0))
        position = AxisParameter("PARAM", bench, ChangeAxis.POSITION)
    ...
    def test_GIVEN_set_jacks_with_height_seesaw_setpoint_non_zero_WHEN_get_control_axis_value_THEN_values_correct(
        self, jack_front_position, jack_rear_position, angle_sp, expected_position, expected_seesaw
    ):
        bench = get_standard_bench()
        bench.beam_path_set_point.set_incoming_beam(PositionAndAngle(0, 0, 0))
        position = AxisParameter("PARAM", bench, ChangeAxis.POSITION)
    ...
    def test_GIVEN_set_alarms_on_jacks_and_slide_WHEN_get_control_axis_alarm_THEN_alarm_is_most_sever(
        self, front_alarm, rear_alarm, slide_alarm, expected_alarm
    ):
        bench = get_standard_bench()
        bench.beam_path_set_point.set_incoming_beam(PositionAndAngle(0, 0, 0))
        position = AxisParameter("PARAM", bench, ChangeAxis.POSITION)
        ...
        bench.beam_path_rbv.axis[ChangeAxis.JACK_FRONT].set_displacement(
            CorrectedReadbackUpdate(0, *front_alarm)
        )
        bench.beam_path_rbv.axis[ChangeAxis.JACK_REAR].set_displacement(
            CorrectedReadbackUpdate(0, *rear_alarm)
        )
        bench.beam_path_rbv.axis[ChangeAxis.SLIDE].set_displacement(
            CorrectedReadbackUpdate(0, *slide_alarm)
        )
    ...
    @parameterized.expand(
        [
            ((ANGLE_OF_BENCH, 1, 0), 2, (2, 2, None)),
            ((0, 1, 0), 0, (-48.74306278, -111.3188069, None)),
            ((0.1, 1, 0), 0, (-46.6006546, -106.4529773, None)),
            ((0, 1, 2), 0, (-48.74306278 + 2, -111.3188069 - 2, None)),
        ]
    )
    def test_GIVEN_bench_in_location_WHEN_define_position_THEN_new_height_defined(
        self, initial_position, define_height_as, expected_positions
    ):
        expected_jack_front_height, expected_jack_rear_height, expected_slide_position = (
            expected_positions
        )
    ...
    @parameterized.expand(
        [
            (
                (0.1, 0, 0),
                0,
                (-48.74306278, -111.3188069, -27.44574943),
            ),  # no height or seesaw set to 0
            (
                (2, 0, 0),
                0.1,
                (-46.6006546, -106.4529773, -26.15894011),
            ),  # no height or seesaw set to non-zero
            ((0, 0, 2), 0, (-48.74306278 + 2, -111.3188069 - 2, -27.44574943)),  # with seesaw
            ((0, 1, 2), 0, (-48.74306278 + 1 + 2, -111.3188069 + 1 - 2, -27.44574943)),
        ]
    )  # with height and seesaw
    def test_GIVEN_bench_in_location_WHEN_define_angle_THEN_new_height_defined(
        self, initial_position, define_height_as, expected_positions
    ):
        expected_jack_front_height, expected_jack_rear_height, expected_slide_position = (
            expected_positions
    ...
    @parameterized.expand(
        [
            (
                ...
                0,
                (-48.74306278, -111.3188069, -27.44574943),
            ),  # no height or angle set to 0
            (
                (0, 0, 0),
                3,
                (-48.74306278 + 3.0, -111.3188069 - 3.0, -27.44574943),
            ),  # no height or angle set to non-zero
            ((0.1, 0, 2), 0, (-46.6006546, -106.4529773, -26.15894011)),  # no height but angle set
            ((0.1, 1, 2), 0, (-46.6006546 + 1, -106.4529773 + 1, -26.15894011)),
        ]
    )  # height, and angle
    def test_GIVEN_bench_in_location_WHEN_define_seesaw_THEN_new_height_defined(
        self, initial_position, define_height_as, expected_positions
    ):
        expected_jack_front_height, expected_jack_rear_height, expected_slide_position = (
            expected_positions
    ...
    @parameterized.expand(
        [
            ...
            (
                ...
                +0.5,
                0.3,
            ),  # non-zero angle and height and seesaw
        ]
    )
    def test_GIVEN_jacks_init_with_height_seesaw_setpoint_set_WHEN_get_parameter_sp_THEN_values_correct(
        self,
        jack_front_position,
        jack_rear_position,
        seesaw_autosave,
...
class TestBenchComponentVertical(unittest.TestCase):
    ...
    def test_GIVEN_vertical_bench_WHEN_moving_chi_THEN_jacks_and_slide_move_to_correct_position(
        self,
    ):
    ...
    def test_GIVEN_set_alarms_on_jacks_and_slide_for_vertical_bench_WHEN_get_control_axis_alarm_THEN_alarm_is_most_sever(
        self, front_alarm, rear_alarm, slide_alarm, expected_alarm
    ):
    ...
    @parameterized.expand(
        [
            (
                (ChangeAxis.TRANS, ChangeAxis.CHI, ChangeAxis.SEESAW),
                (),
                (),
                (ChangeAxis.JACK_FRONT,),
                True,
    ...
    def test_GIVEN_changing_true_on_some_axis_WHEN_changing_set_on_an_axis_THEN_bench_chi_seesaw_and_trans_on_changing_to_expected_answer(
        self,
        inital_setup_false,
        inital_setup_true,
        axes_to_set_false,
