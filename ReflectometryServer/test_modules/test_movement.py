...
class TestMovementIntercept(unittest.TestCase):
    ...
    def test_GIVEN_movement_45_to_z_at_beam_offset_along_z_WHEN_z_of_movement_axis_changes_THEN_position_is_as_expected(
        self,
    ):
        y = 0
        z = 7
...
class TestMovementRelativeToBeam(unittest.TestCase):
    ...
    def test_GIVEN_movement_at_30_to_z__beam_intercept_above_and_to_the_right_of_zero_WHEN_set_position_relative_to_beam_to_10_THEN_position_is_at_10_along_intercept(
        self, add_angle
    ):
    ...
    @parameterized.expand([(0,), (360,), (-360,)])
    def test_GIVEN_movement_at_30_to_z_beam_intercept_below_and_to_the_left_of_zero_WHEN_set_position_relative_to_beam_to_10_THEN_position_is_at_10_along_intercept(
        self, add_angle
    ):
        # here the beam intercept is above and to the right of the zero point
        movement = LinearMovementCalc(PositionAndAngle(0, 10, 30 + add_angle))
    ...
    @parameterized.expand([(0,), (360,), (-360,)])
    def test_GIVEN_movement_at_minus_30_to_z_beam_intercept_above_and_to_the_left_of_zero_WHEN_set_position_relative_to_beam_to_10_THEN_position_is_at_10_along_intercept(
        self, add_angle
    ):
        # here the beam intercept is above and to the right of the zero point
        movement = LinearMovementCalc(PositionAndAngle(0, 10, -30 + add_angle))
    ...
    @parameterized.expand([(0,), (360,), (-360,)])
    def test_GIVEN_movement_at_minus_30_and_similar_to_z_beam_intercept_below_and_to_the_right_of_zero_WHEN_set_position_relative_to_beam_to_10_THEN_position_is_at_10_along_intercept(
        self, add_angle
    ):
        # here the beam intercept is above and to the right of the zero point
        movement = LinearMovementCalc(PositionAndAngle(0, 10, -30 + add_angle))
