...
class TestDriverUtils(unittest.TestCase):
    ...
    def test_GIVEN_enum_param_WHEN_get_monitor_updates_THEN_all_pvs_and_values_returned(self):
        ...
        assert_that(
            result,
            contains_inanyorder(
                ("{}".format(pvname), index_of_opt1, None, None),
    ...
    def test_GIVEN_enum_param_WHEN_update_event_processed_using_get_param_update_from_event_THEN_fields_(
        self,
    ):
        ...
        result_name, result_value, result_severity, result_status = (
            self.driver_helper.get_param_update_from_event(
                self.pvname, self.param.parameter_type, update
            )
        )
    ...
    def test_GIVEN_enum_param_WHEN_update_event_processed_using_get_param_update_from_event_and_value_is_not_in_enum_THEN_value_is_set_to_minus_one_and_error_in_alarms(
        self,
    ):
