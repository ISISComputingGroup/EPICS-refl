...
class TestMotorPVWrapper(unittest.TestCase):
    ...
    def test_GIVEN_base_pv_WHEN_creating_motor_pv_wrapper_THEN_resolution_is_initialised_correctly(
        self,
    ):
    ...
    def test_GIVEN_base_pv_WHEN_creating_motor_pv_wrapper_THEN_velocity_is_initialised_correctly(
        self,
    ):
    ...
    def test_GIVEN_base_pv_WHEN_creating_motor_pv_wrapper_THEN_max_velocity_is_initialised_correctly(
        self,
    ):
    ...
    def test_GIVEN_base_pv_WHEN_creating_motor_pv_wrapper_THEN_setpoint_is_initialised_correctly(
        self,
    ):
        expected_sp = self.sp
    ...
    def test_GIVEN_base_pv_and_positive_dir_WHEN_creating_motor_pv_wrapper_THEN_backlash_distance_is_initialised_correctly(
        self,
    ):
    ...
    def test_GIVEN_base_pv_and_negative_dir_WHEN_creating_motor_pv_wrapper_THEN_backlash_distance_is_initialised_correctly(
        self,
    ):
    ...
    def test_GIVEN_base_pv_WHEN_creating_motor_pv_wrapper_THEN_backlash_velocity_is_initialised_correctly(
        self,
    ):
    ...
    def test_GIVEN_base_pv_WHEN_creating_motor_pv_wrapper_THEN_low_soft_limit_is_initialised_correctly(
        self,
    ):
    ...
    def test_GIVEN_base_pv_WHEN_creating_motor_pv_wrapper_THEN_direction_is_initialised_correctly(
        self,
    ):
    ...
    def test_GIVEN_base_velocity_is_non_zero_WHEN_initialising_motor_pv_wrapper_THEN_min_velocity_set_to_vbas(
        self,
    ):
        vbas = 0.125
    ...
    def test_GIVEN_base_velocity_is_zero_and_scale_factor_is_custom_WHEN_initialising_motor_pv_wrapper_THEN_min_velocity_set_to_custom_fraction_of_vmax(
        ...
        self.wrapper_with_custom_scale_level = MotorPVWrapper(
            self.motor_name, ca=self.mock_ca, min_velocity_scale_factor=scale_factor
        )
    ...
    def test_GIVEN_base_velocity_is_zero_and_scale_factor_is_nonsensical_WHEN_initialising_motor_pv_wrapper_THEN_min_velocity_set_to_default_fraction_of_vmax(
        self,
    ):
        scale_level = -4
        ...
        self.wrapper_with_custom_scale_level = MotorPVWrapper(
            self.motor_name, ca=self.mock_ca, min_velocity_scale_factor=scale_level
        )
    ...
    def test_GIVEN_base_velocity_is_zero_and_scale_factor_is_default_WHEN_initialising_motor_pv_wrapper_THEN_min_velocity_set_to_default_fraction_of_vmax(
        self,
    ):
    ...
    def test_GIVEN_base_velocity_is_zero_and_scale_factor_is_zero_WHEN_initialising_motor_pv_wrapper_THEN_min_velocity_set_to_default(
        self,
    ):
        expected_min_velocity = self.vmax / DEFAULT_SCALE_FACTOR
        scale_factor = 0
...
class TestJawsAxisPVWrapper(unittest.TestCase):
    ...
    def test_GIVEN_base_pv_and_motor_is_vertical_WHEN_creating_jawgap_wrapper_THEN_pvs_are_correct(
        self,
    ):
    ...
    def test_GIVEN_base_pv_and_motor_is_horizontal_WHEN_creating_jawgap_wrapper_THEN_pvs_are_correct(
        self,
    ):
    ...
    def test_GIVEN_base_pv_and_motor_is_vertical_WHEN_creating_jawcent_wrapper_THEN_pvs_are_correct(
        self,
    ):
    ...
    def test_GIVEN_base_pv_and_motor_is_horizontal_WHEN_creating_jawcent_wrapper_THEN_pvs_are_correct(
        self,
    ):
    ...
    def test_GIVEN_initialised_jaw_gap_WHEN_get_backlash_distance_THEN_distance_is_0_because_jaws_do_not_backlash(
        self,
    ):
        wrapper = JawsGapPVWrapper(self.jaws_name, is_vertical=False, ca=self.mock_ca)
        wrapper.initialise()
    ...
    def test_GIVEN_vbas_not_set_and_jaw_gap_initialised_WHEN_get_minimum_velocity_THEN_minimum_velocity_is_default(
        self,
    ):
    ...
    def test_GIVEN_soft_limits_not_set_and_jaw_gap_initialised_WHEN_get_limits_THEN_limits_are_infinity(
        self,
    ):
        wrapper = JawsGapPVWrapper(self.jaws_name, is_vertical=False, ca=self.mock_ca)
        wrapper.initialise()
    ...
    def test_GIVEN_soft_limits_not_set_and_jaw_centre_initialised_WHEN_get_limits_THEN_limits_are_infinity(
        self,
    ):
        wrapper = JawsCentrePVWrapper(self.jaws_name, is_vertical=False, ca=self.mock_ca)
        wrapper.initialise()
    ...
    def test_GIVEN_vbas_set_and_jaw_gap_initialised_WHEN_get_minimum_velocity_THEN_minimum_velocity_is_default(
        self,
    ):
        expected = 0.123
        for direction in ["JN", "JE", "JS", "JW"]:
...
class TestAggregateMonitorEvents(unittest.TestCase):
    ...
    def test_GIVEN_two_events_of_different_type_WHEN_processed_one_has_exception_THEN_only_non_exception_events_triggered(
        self,
    ):
        expected_value1 = "HI"
        expected_value2 = 1
    ...
    def test_GIVEN_nothing_WHEN_one_event_wait_then_second_event_THEN_events_are_both_processed(
        self,
    ):
    ...
    @patch("ReflectometryServer.pv_wrapper.ChannelAccess")
    def test_GIVEN_moving_pv_does_not_exist_WHEN_event_THEN_event_is_processed(
        self, channel_access
    ):
