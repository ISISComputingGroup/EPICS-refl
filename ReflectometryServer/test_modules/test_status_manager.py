...
from ReflectometryServer.server_status_manager import _ServerStatusManager, STATUS, PROBLEMS, ProblemInfo
...
class TestStatusManager(unittest.TestCase):
    ...
    def test_GIVEN_major_severity_WHEN_new_problem_occurs_THEN_new_error_added_as_key_with_source_as_value(self):
    ...
    def test_GIVEN_minor_severity_WHEN_new_problem_occurs_THEN_new_warning_added_as_key_with_source_as_value(self):
        problem_description = "problem_description"
        source = Mock()
    ...
    def test_GIVEN_unknown_severity_WHEN_new_problem_occurs_THEN_new_other_problem_added_as_key_with_source_as_value(self):
        problem_description = "problem_description"
        source = Mock()
    ...
    def test_GIVEN_new_source_WHEN_known_problem_occurs_THEN_problem_entry_modified_by_adding_another_source(self):
        ...
        self.status_manager.update_active_problems(ProblemInfo(problem_description, source_1, problem_severity))
        self.status_manager.update_active_problems(ProblemInfo(problem_description, source_2, problem_severity))
        actual = self.status_manager.active_errors
    ...
    def test_GIVEN_known_source_WHEN_new_problem_occurs_THEN_new_problem_added_as_key_with_source_as_value(self):
        ...
        self.status_manager.update_active_problems(ProblemInfo(problem_description_1, source, problem_severity))
        self.status_manager.update_active_problems(ProblemInfo(problem_description_2, source, problem_severity))
        actual = self.status_manager.active_errors
    ...
    def test_GIVEN_different_severity_levels_WHEN_adding_problems_THEN_server_status_reflects_highest_severity(self, problem_severity_1, problem_severity_2, expected):
        problem_description_1 = "problem_description_1"
        problem_description_2 = "problem_description_2"
        source = Mock()
