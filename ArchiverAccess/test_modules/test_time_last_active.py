...
class TestTimeLastActive(TestCase):
    ...
    def test_GIVEN_there_is_time_last_active_file_WHEN_get_time_last_active_THEN_date_time_in_file_returned(self):
        ...
        result = time_last_active.get()

        assert_that(result, is_(expected_time))

    def test_GIVEN_there_is_time_last_active_file_which_is_earlier_than_max_allowed_WHEN_get_time_last_active_THEN_current_date_minus_max_is_returned(self):
        max_delta = 2
