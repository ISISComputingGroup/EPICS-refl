...
VALID_SYNOPTIC_DATA = u"""<?xml version="1.0" ?>
...
"""
INVALID_SYNOPTIC_DATA = u"""<?xml version="1.0" ?>
<instrument xmlns="http://www.isis.stfc.ac.uk//instrument">
    <name>test1</name>
    <components>
        <component>
...
class TestConfigFileEventHandler(unittest.TestCase):
    ...
    def test_when_reading_valid_xml_data_then_is_successfully_returned_by_check_valid(self):
        ...
        # Act
        self.synoptic_manager.load_synoptic.return_value = VALID_SYNOPTIC_DATA
        xml_data = self.eh._check_valid(path)

        # Assert
        self.assertEqual(xml_data, VALID_SYNOPTIC_DATA)
    ...
    def test_when_file_modified_event_then_reload_and_update(self):
        ...
        self.synoptic_manager.update.assert_called_with(synoptic_name, VALID_SYNOPTIC_DATA)
        self.assertRaises(NotConfigFileException)
